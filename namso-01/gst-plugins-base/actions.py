...
def install():
    ...
    pisitools.remove("/usr/share/locale/*/LC_MESSAGES/.mo")
    for lang in shelltools.ls("po/*.po"):
        pisitools.domo(lang, shelltools.baseName(lang).replace(".po", ""), "gst-plugins-base-0.10.mo")
