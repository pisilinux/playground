...
sources = ["hotspot.tar.bz2", "openjdk.tar.bz2", "corba.tar.bz2", "jaxp.tar.bz2", "jaxws.tar.bz2", "langtools.tar.bz2", "jdk.tar.bz2"]

def setup():
    
    for source in sources:
      shelltools.system("mv %s src-%s" % (source, source))
    ...
    autotools.rawConfigure("\
                            ...
                            --with-openjdk-src-zip=src-openjdk.tar.bz2 \
                            --with-hotspot-src-zip=src-hotspot.tar.bz2 \
                            --with-corba-src-zip=src-corba.tar.bz2 \
                            --with-jaxp-src-zip=src-jaxp.tar.bz2 \
                            --with-jaxws-src-zip=src-jaxws.tar.bz2 \
                            --with-jdk-src-zip=src-jdk.tar.bz2 \
                            --with-langtools-src-zip=src-langtools.tar.bz2 \
