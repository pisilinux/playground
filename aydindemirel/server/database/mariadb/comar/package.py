...
def postInstall(fromVersion, fromRelease, toVersion, toRelease):
    ...
    os.system("/bin/chown -R mysql:mysql /usr/share/mysql")
    os.system("/bin/chmod -R 0755 /usr/share/mysql")
    ...
    if not os.path.exists("/var/lib/mysql/mysql"):
        # Create the database
        os.system("/usr/bin/mysql_install_db --datadir=/var/lib/mysql --basedir=/usr --explicit_defaults_for_timestamp --user=mysql --force")
