...
def install():
    ...
    shelltools.system("ln -s /usr/share/java/maven/bin/mvn %s/usr/bin/mvn" % (get.installDIR(), get.installDIR()))
    shelltools.system("ln -s /usr/share/java/maven/bin/mvnDebug %s/usr/bin/mvnDebug" % (get.installDIR(), get.installDIR()))
