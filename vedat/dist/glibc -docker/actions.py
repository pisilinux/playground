...
WorkDir = "glibc-2.21"
#pisitools.dosed("elf/Makefile", "tst-audit2-ENV", "CFLAGS-tst-audit2.c += -fno-builtin")
...
def setup():
    ...
    shelltools.system("sed -e '/tst-audit2-ENV/i CFLAGS-tst-audit2.c += -fno-builtin' -i elf/Makefile")
    shelltools.system("sed -e '/ia32/s/^/1:/' -e '/SSE2/s/^1://' -i  sysdeps/i386/i686/multiarch/mempcpy_chk.S")
