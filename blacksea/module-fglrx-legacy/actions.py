...
BuildDir = "arch/x86_64/lib/modules/fglrx/build_mod/"
...
def install():
   ...
   # Controlcenter libraries
    ...
    pisitools.insinto("/lib/modules/%s/extra" % KDIR, "arch/x86_64/lib/modules/fglrx/fglrx.%s.ko" % KDIR, "fglrx.ko")
    pisitools.insinto("/lib/modules/%s/kernel/drivers/char/drm" % KDIR, "arch/x86_64/lib/modules/fglrx/fglrx.%s.ko" % KDIR, "fglrx.ko")
