...
def install():
   ...
   # pisitools.insinto("usr/share/ati/lib64", "arch/%s/usr/share/ati/lib*/*" % Target)
    ...
    #Necessary to choose graphic card
    pisitools.insinto("%s/fglrx" % Libdir, "./arch/x86_64/usr/lib64/fglrx/switchlibGL")
    pisitools.insinto("%s/fglrx" % Libdir, "./arch/x86_64/usr/lib64/fglrx/switchlibglx")
    ...
    # ayhanın ekledikleri
    #pisitools.dosym("switchlibGL", "/usr/lib/fglrx/switchlibGL")
    #pisitools.dosym("switchlibglx", "/usr/lib/fglrx/switchlibglx")
